...
enum Sort_Priority{Target_Me,Eventually_Reach_Me,Never_Reach_Base,Eventually_Reach_Op,Target_Op};
...
class player{
    ...
    public:
        ...
        int get_my_hero(const int i,const char attr_name[]) const;
        int get_op_hero(const int i,const char attr_name[]) const;
        int get_monster(const int i,const char attr_name[]) const;
